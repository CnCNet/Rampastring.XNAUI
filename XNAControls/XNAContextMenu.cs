...
public class XNAContextMenu : XNAControl
{
    ...
    protected virtual int DrawItem(int index, Point point)
    {
        ...
        int textY = contentTop + Math.Max(0, (contentHeight - FontManager.GetFontVerticalOffset(FontIndex)) / 2);
        ...
        if (item.HintText != null)
        {
            ...
            int hintTextY = contentTop + Math.Max(0, (contentHeight - FontManager.GetFontVerticalOffset(HintFontIndex)) / 2);
